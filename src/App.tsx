...
export default function App() {
  ...
  const [username, setUsername] = useState(() => {
    return localStorage.getItem("freetext_username") || "boiachiver";
  });
  ...
  function saveProfile() {
    const cleanName = editName.trim() || "Boi Achiver";
    ...
    localStorage.setItem("freetext_user", cleanName);
    localStorage.setItem("freetext_username", cleanUsername);
    localStorage.setItem("freetext_bio", cleanBio);
    localStorage.setItem("freetext_avatar", editAvatar);
            ...
            <section className="page-section">
              <div className="profile-card">
                ...
                <div className="profile-main">
                  <Avatar src={profileAvatar} size={96} />
        ...
        <aside className="right-rail">
          <div className="account-card">
            <div className="account-row">
              <Avatar src={profileAvatar} size={54} />
        ...
        >
          ...
          >
            ...
            <div className="create-user">
              <Avatar src={profileAvatar} size={45} />
      ...
      {showEditProfile && (
        ...
        >
          ...
          >
            ...
            <div className="create-user">
              <Avatar src={editAvatar} size={70} />

              <div>
                <strong>{editName || "Your name"}</strong>
                <span>@{editUsername || "username"}</span>
              </div>
            </div>
            ...
            <button className="publish-button" onClick={saveProfile}>
              Save Changes
            </button>
          </div>
        </div>
